...
nodeVersionCmd="node --version"
osCmd="uname -a"
envinfo="yes | npx envinfo --preset playwright"
...
$versionCmd
echo "\Node Version: $nodeVersionCmd"
$nodeVersionCmd
echo "\OS Version: $osCmd"
$osCmd
echo "\envinfo Version: $envinfo"
$envinfo
...
# Print the contents of the test-results directory
echo -e "\nContents of the test-results directory after test execution:"
find test-results || echo "Failed to find the test-results directory."
# ls -l test-results || echo "Failed to print ls the test-results directory."
